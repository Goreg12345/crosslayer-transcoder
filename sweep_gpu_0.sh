...
python cli.py fit --config ./config/default.yaml --trainer.devices [3] --model.lambda_sparsity 0.001 --model.init_args.replacement_model_device_map "cuda:3" --model.init_args.d_features 8000 --data.init_args.batch_size 500 --trainer.accumulate_grad_batches 16 --trainer.max_steps 10_000
